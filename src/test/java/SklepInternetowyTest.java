...
import pl.sda.arppl4.kolekcje_java.sklepinternetowy.KategoriaProdukt;
...
public class SklepInternetowyTest {
    ...
    public void test_dodajProdukt(){
        ...
        market.dodajProdukt("test", 10.0, KategoriaProdukt.MEBLE);
    ...
    public void test_dodajDwaTakieSameProduktyPowinnoNieDzialac(){
        Market market = new Market();
        market.dodajProdukt("test", 10.0, KategoriaProdukt.MEBLE);
        market.dodajProdukt("test", 15.0, KategoriaProdukt.SAMOCHODY);
    ...
    public void test_mozliweJestZwrocenieWszystkichSprzedanychProduktow(){
        Market market = new Market();
        market.dodajProdukt("test1", 10.0, KategoriaProdukt.MEBLE);
        market.dodajProdukt("test2", 11.0, KategoriaProdukt.MEBLE);
        market.dodajProdukt("test3", 10.0, KategoriaProdukt.MEBLE);
        market.dodajProdukt("test4", 10.0, KategoriaProdukt.MEBLE);
