...
import pl.sda.arppl4.kolekcje_java.Kalkulator;
...
public class KalkulatorTest {
    ...
    @Test
    public void test_naPoczatkuKalkulatoraZwracamyWynik0() {
        obiektTestowany = new Kalkulator();
        int wynik = obiektTestowany.getOstatniWynik();
        Assert.assertEquals("Kalkulator powinien zwrocic 0 jesli nie wykonalismy wczesniej dzialan", 0, wynik);
    }
    @Test
